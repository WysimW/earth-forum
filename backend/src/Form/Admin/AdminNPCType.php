...
class AdminNPCType extends AbstractType
{   
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('status', ChoiceType::class, [
                'label' => 'Statut',
                'choices' => [
                    'En attente' => Npc::STATUS_PENDING,
                    'Validé' => Npc::STATUS_VALIDATED,
                    'Rejeté' => Npc::STATUS_REJECTED,
                    'Brouillon' => Npc::STATUS_DRAFT,
                    'En cours d\'édition' => Npc::STATUS_EDITING,
                    'Abandonné' => Npc::STATUS_ABANDONED,
                ]
