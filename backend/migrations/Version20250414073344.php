 ...
 */
final class Version20250414073344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `character` (id INT AUTO_INCREMENT NOT NULL, universe_id INT DEFAULT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, first_name VARCHAR(100) DEFAULT NULL, last_name VARCHAR(100) DEFAULT NULL, pseudonyms LONGTEXT DEFAULT NULL, actual_pseudo VARCHAR(255) DEFAULT NULL, gender VARCHAR(20) DEFAULT NULL, sexual_orientation VARCHAR(50) DEFAULT NULL, moral_affiliation VARCHAR(50) DEFAULT NULL, factions LONGTEXT DEFAULT NULL, civil_status VARCHAR(50) DEFAULT NULL, occupation VARCHAR(255) DEFAULT NULL, equipment LONGTEXT DEFAULT NULL, weaknesses LONGTEXT DEFAULT NULL, age VARCHAR(255) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, biography LONGTEXT DEFAULT NULL, alias VARCHAR(50) DEFAULT NULL, status VARCHAR(20) NOT NULL, personality LONGTEXT DEFAULT NULL, appearance LONGTEXT DEFAULT NULL, abilities LONGTEXT DEFAULT NULL, validated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', status_message LONGTEXT DEFAULT NULL, moderation_note LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_937AB0345CD9AF2 (universe_id), INDEX IDX_937AB034A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE forum (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, universe_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, banner VARCHAR(255) DEFAULT NULL, hero_logo VARCHAR(255) DEFAULT NULL, is_roleplay TINYINT(1) DEFAULT 0 NOT NULL, status VARCHAR(20) NOT NULL, position INT NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_852BBECD989D9B62 (slug), INDEX IDX_852BBECD12469DE2 (category_id), INDEX IDX_852BBECD5CD9AF2 (universe_id), INDEX IDX_852BBECD727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE forum_category (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, slug VARCHAR(255) NOT NULL, position INT NOT NULL, home_order INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_21BF9426989D9B62 (slug), INDEX IDX_21BF9426C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, thread_id INT NOT NULL, author_id INT DEFAULT NULL, character_id INT DEFAULT NULL, content LONGTEXT DEFAULT NULL, edited_at DATETIME DEFAULT NULL, type VARCHAR(20) NOT NULL, is_draft TINYINT(1) DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_5A8A6C8DE2904019 (thread_id), INDEX IDX_5A8A6C8DF675F31B (author_id), INDEX IDX_5A8A6C8D1136BE75 (character_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE thread (id INT AUTO_INCREMENT NOT NULL, forum_id INT NOT NULL, author_id INT DEFAULT NULL, character_creator_id INT DEFAULT NULL, character_sheet_id INT DEFAULT NULL, location_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, type VARCHAR(20) NOT NULL, status VARCHAR(20) NOT NULL, description LONGTEXT DEFAULT NULL, first_post_content LONGTEXT DEFAULT NULL, tags VARCHAR(255) DEFAULT NULL, max_participants INT DEFAULT NULL, sticky TINYINT(1) DEFAULT NULL, visible_to_characters_only TINYINT(1) DEFAULT 0 NOT NULL, is_draft TINYINT(1) DEFAULT 0 NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_31204C8329CCBAD0 (forum_id), INDEX IDX_31204C83F675F31B (author_id), INDEX IDX_31204C83D0AEB720 (character_creator_id), INDEX IDX_31204C83D313EF34 (character_sheet_id), INDEX IDX_31204C8364D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE univers (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME DEFAULT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_51AD969D989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
